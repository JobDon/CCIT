...
const redirects = {
  ...
  "Professional & Advisory Services":
    "/services#professional-advisory-services",
  "Offensive Security & Testing": "/services#offensive-security-testing",
  "Threat Intelligence & Incident Response":
    "/services#threat-intelligence-response",
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Hero Section */}
      <div className="flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 pt-24 pb-24">
